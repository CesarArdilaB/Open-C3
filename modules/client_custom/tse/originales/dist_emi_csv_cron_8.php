...
mail("cac@tse.com.co,andres.ardila@parasuempresa.com","Emision 8 Generadose","Empeso a generarse emision del mes actual"); 


$Date = strtotime(date('Y-m-15'));
$dt_elMesPasado = date('Y-m-') ; // resta 1 mes
...
echo "<br><br><br><br>".count($SelectDATA);
...
$new_report=fopen("../../../tmp/emision_distribucion_autogenerado_dia_p8.csv","w");
 
fwrite($new_report, $htm);

fclose($new_report);

mail("cac@tse.com.co,andres.ardila@parasuempresa.com","Emision 8 Generadose","Termino de generarse emision del mes actual"); 
