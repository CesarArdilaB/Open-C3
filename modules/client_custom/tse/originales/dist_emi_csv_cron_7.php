...
mail("cac@tse.com.co,andres.ardila@parasuempresa.com","Emision 7 Generadose","Empeso a generarse emision del mes 7"); 


$Date = strtotime(date('Y-m-15'));
$dt_elMesPasado = date('Y-m-',strtotime('-1 month',$Date)) ; // resta 1 mes
...
$new_report=fopen("../../../tmp/emision_distribucion_autogenerado_dia_p7.csv","w");
 
fwrite($new_report, $htm);
 
fclose($new_report);
 
 mail("cac@tse.com.co,andres.ardila@parasuempresa.com","Emision 6 Generadose","Termino de generarse emision del mes 7"); 
