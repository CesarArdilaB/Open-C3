...
$htm .= $SelectDATA[$i][af13_33]."|".$SelectDATA[$i][af13_34]."|".$campanaTEXT."|".$estadoINV."|".$SelectDATA[$i][af13_39]."|".$SelectDATA[$i][af13_41]."|".$SelectDATA[$i][af13_40]."|".$actData."|".$SelectDATA[$i][af13_128]."|".$fechaSalidaINV."|".$fechaEntregaINV."|".$Indicacion."|".$entData."|".$operadorText."|".$gescallText."|".substr($SelectDATA[$i][af13_34],0,10)."|".$CiudadBText."|".$SelectDATA[$i][af13_42]."|".$SelectDATA[$i][af13_171]."|".$BodegaTxt."|".$gmesaText."|".$pventaText."|".$SelectDATA[$i][af13_93]."|".$FeedBACKT."|".$SelectDATA[$i][af13_35]."|".$SelectDATA[$i][af13_36]."|".$tentregaText."|".$SelectDATA[$i][af13_152]."|".$coddirText."|".$SelectDATA[$i][af13_145]."|".$SelectDATA[$i][af13_52]."|".$SelectDATA[$i][autof_matrizprincipal_1_id]."\r";
