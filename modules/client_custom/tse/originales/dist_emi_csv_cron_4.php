...
//mail("cac@tse.com.co,andres.ardila@parasuempresa.com","Emision 4 Generadose","Se empezo a generar emision del mes 4");

//date_default_timezone_set('America/Bogota');

mail("cac@tse.com.co,andres.ardila@parasuempresa.com","Emision 4 Generadose","Empeso a generarse emision del mes 4"); 


$Date = strtotime(date('Y-m-15'));
$dt_elMesPasado = date('Y-m-',strtotime('-4 month',$Date)) ; // resta 1 mes
...
$new_report=fopen("../../../tmp/emision_distribucion_autogenerado_dia_p4.csv","w");
 
fwrite($new_report, $htm);
 
fclose($new_report);
 
mail("cac@tse.com.co,andres.ardila@parasuempresa.com","Emision 4 Generadose","Se termino de generar emision del mes 4"); 
