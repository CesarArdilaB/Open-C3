...
switch($_GET[rid]){
	...
	$labesARR 	= array("Campaña","Label","Cedula","Pseudocodigo","Fecha Recibido Fisico","Fecha Entrega","Estado","Bodega","Lote","Nombre del Cliente","Bolsa Seguridad Salida","Tipo de Tarjeta","Codigo Oficina","Direccion Oficina","Tipo Entrega","Gestion Call","Gestion Mesa","Activacion","Fecha de Activacion","Cupo","FRANQUICIA / MARCA","Feed Back","Mensajero","Id Registro");
	$camposARR	= array("af13_38","af13_51","af13_39","af13_41","af13_34","fechasalida","idestado","idbodega","af13_167","af13_40","af13_152","af13_253","af13_61","af13_47","af13_155","af13_109","af13_100","af13_126","af13_128","af13_42","af13_942","feedback","idmensajero","autof_matrizprincipal_1_id");
	$camposQ	= "af13_38,af13_51,af13_39,af13_41,fechasalida,idestado,idbodega,af13_167,af13_40,af13_152,af13_253,af13_61,af13_47,af13_155,af13_109,af13_100,af13_126,af13_128,af13_942,autof_matrizprincipal_1_id";
	...
	$labesARR 	= array("Campaña","Label","Cedula","Pseudocodigo","Fecha Recibido Fisico","Fecha Entrega","Estado","Bodega","Lote","Nombre del Cliente","Bolsa Seguridad Salida","Tipo de Tarjeta","Codigo Oficina","Direccion Oficina","Tipo Entrega","Gestion Call","Gestion Mesa","Activacion","Fecha de Activacion","Cupo","FRANQUICIA / MARCA","Id Registro");
	$camposARR	= array("af13_38","af13_51","af13_39","af13_41","af13_34","fechasalida","idestado","idbodega","af13_167","af13_40","af13_152","af13_253","af13_61","af13_47","af13_155","af13_109","af13_100","af13_126","af13_109","af13_42","af13_942","autof_matrizprincipal_1_id");
	$camposQ	= "af13_38,af13_51,af13_39,af13_41,fechasalida,idestado,idbodega,af13_167,af13_40,af13_152,af13_253,af13_61,af13_47,af13_155,af13_109,af13_100,af13_126,af13_128,af13_42,af13_942,autof_matrizprincipal_1_id";
	$tablas		.= ",autof_matrizprincipal_1";
	...
	case "callcenter1";
	$labesARR 	= array("Cedula","Nombre del Cliente","Campaña","Telefono","Ciudad","Operador","Tipo de Tarjeta","Gestion Call","Gestion Mesa","Activacion","Fecha de Activacion","Fecha Agendamiento","Hora Agendamiento","Fecha Preagenda","Id Registro");
	$camposARR	= array("af13_39","af13_40","af13_38","af13_43","af13_67","name","af13_253","af13_109","af13_100","af13_126","af13_128","fechaA","horaA","fechaPA","autof_matrizprincipal_1_id");
...
$consulta = $sqlm->sql_select($tablas,$camposQ,$clausulasD." = ".$fechacomp." AND  YEAR($campofecha) = YEAR('".$fechageneral."') AND $campocompara = ".$valorcompara." $ClausulasADD",0);
...
?>
  ...
  elseif($camposARR[$o] == "fechaPA")		{ 
  
    	$AFechaV = $sqlm->sql_select("agenda_tmp","fecha","idregistro = '".$consulta[$i][autof_matrizprincipal_1_id]."' ORDER BY id_agendatmp DESC",0);
  		if(is_array($AFechaV)){$TextoPrint = $AFechaV[0][fecha];}else{$TextoPrint = "";}
		$C=2;
