...
<div align="center" class="rounded-corners-gray">
  <form name="form1" method="post" onSubmit="EnviarLinkForm('PersInf','<?=$RAIZHTTP?>/modules/client_custom/compumax/reportefechasmesa.php?op=1',this);return false;">
...
$SelectData = $sqlm->sql_select("history_1,autof_formulario_2","*","fechahora BETWEEN '$_GET[fecha_ini]' AND '$_GET[fecha_fin]' AND autof_formulario_2_id	= id_reg AND af27_196 = '$_GET[tipo]'",0);
...
?>
  <tr>
    ...
    <td bgcolor="#FFFFFF" class="textospadding"><?=$SelectData[$i][af27_184	]?></td>
    <td bgcolor="#FFFFFF" class="textospadding"><?=$SelectData[$i][af27_183]?></td>
    <td bgcolor="#FFFFFF" class="textospadding"><?=$SelectData[$i][af27_185]?></td>
    <td bgcolor="#FFFFFF" class="textospadding"><?=$SelectData[$i][af27_188]?></td>
    <td bgcolor="#FFFFFF" class="textospadding"><?=$SelectData[$i][af27_186]?></td>
    <td bgcolor="#FFFFFF" class="textospadding"><?=$SelectData[$i][af27_189]?></td>
