...
$VerifConfigSaved = $sqlm->sql_select("agenda_camconfig","*","idcampana = '$_POST[idcam]'",0);

if(is_array($VerifConfigSaved))	{

$sqlm->update_regs("agenda_camconfig","$_POST[campoup] = '$_POST[campoSel]'","idcampana = '$_POST[idcam]'",0);

								}
else 	{
	
$sqlm->inser_data("agenda_camconfig","$_POST[campoup],idcampana","'$_POST[campoSel]','$_POST[idcam]'",0);
