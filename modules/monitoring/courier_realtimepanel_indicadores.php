...
$LastDateData = $sqlm->sql_select("agenda","geotag,horaup","idmensajero = '".$MensajerosLista[$i][id_mensajero]."' AND fecha = '$fecha_act' AND feedback != '0' ORDER BY horaup DESC",0);
if(is_array($LastDateData)){$Entregadas = count($LastDateData);}else{ $Entregadas=0; }
...
<tr bgcolor="#CCCCCC">
  <td colspan="7" align="center" bgcolor="#FFFFFF" class="textos_titulos">
