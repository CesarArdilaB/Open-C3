...
?>
<link rel="stylesheet" href="jquery-ui.css" id="theme">
<link rel="stylesheet" href="jquery.image-gallery.css">
<link rel="stylesheet" href="jquery.fileupload-ui.css">
<link rel="stylesheet" href="style.css">
<? require_once("../../appcfg/func_mis.php"); ?>
<div id="fileupload">
    <form action="php/procesar.php?Idcamania=<?=$_GET[Idcamania]?>&IdIdent=<?=$_GET[IdIdent]?>" method="POST" enctype="multipart/form-data">
